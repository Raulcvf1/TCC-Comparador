window.onload = function() {
    ...
    function fetch_get_selectDisciplinaProfessor(id) {
        ...
        const uri = "/disciplina/professor/" + id;
        ...
        .then((jsonResposta) => {
            ...
            if (jsonResposta.status == true) {
                createDisciplinasJumbotrons(jsonResposta.dados);
            } else {
    ...
    function createDisciplinasJumbotrons(disciplinas) {
        ...
        disciplinas.forEach((disciplina) => {
            ...
            title.textContent = disciplina.serie + "° ano " + disciplina.nome; // Nome da disciplina
        ...
        const targetElement = document.querySelector('.container-fluid .col-9'); // Local onde deseja inserir
