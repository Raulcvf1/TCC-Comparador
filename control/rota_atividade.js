    ...
    */
    app.post("/atividade", (request, response) => {
        ...
        if (tokenValido.status == true) {
            ...
            const quantidade = request.body.quantidade_exercicios;
            const Disciplina_idDisciplina = request.body.Disciplina_idDisciplina;
            const professor_registro = request.body.professor_registro; //REGISTRO DO PROFESSOR, FICAR DE OLHO
            ...
            .then((resultadosBanco) => {
                ...
                const atividadeDir = path.join(__dirname, '../professor/' + professor_registro + '/' + Disciplina_idDisciplina, lastInsertId.toString());
                fs.mkdir(atividadeDir, (err) => {
                    if (err) {
                ...
                // Criar subpasta com o ID do professor
                const inputDir = path.join(__dirname, '../professor/' + professor_registro + '/' + Disciplina_idDisciplina, lastInsertId.toString(), 'input');
                ...
                dados: {
                    ...
                    qunatidade_exercicios: atividade.getQuantidade(),
                },
                };
